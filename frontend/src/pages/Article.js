...
const RecuperationArticle=()=>{
    ...
    function suppressionVideo(liensupprime, liensqlsupprime, idProduit){
    ...
    function suppressionVideoCharge(liensupprime, liensqlsupprime, idProduit){
    ...
    function modificationTexte(modifietexte, idProduit){
   ...
   function modificationTexteCharge(modifietexte, idProduit){
  ...
  function boutonSuppressionImage(forum){
    return <button
    onClick={(e)=>{
      let searchParams = new URLSearchParams(window.location.search);
      let idProduit;
      ...
      suppressionVideo(liensupprime, liensqlsupprime, idProduit);
      suppressionVideoCharge(liensupprime, liensqlsupprime, idProduit);
    }}
    >Supprimer</button>
  };

  function boutonModifierTexte(){
    return <button className="buttonModifier"
    onClick={(e)=>{
      let searchParams = new URLSearchParams(window.location.search);
      let idProduit;
      for (let p of searchParams) {
      ...
      modificationTexte(modifietexte, idProduit);
    if(parseInt(document.cookie.split(";")[0].split("=")[1]) === 1){
      modificationTexteCharge(modifietexte, idProduit);
    }
  }}
    >Modifier</button>
};

function suppressionTexte(supprimetexte, idProduit){
...
function suppressionTexteCharge(supprimetexte, idProduit){
...
function boutonSupprimerTexte(forum){
  return <button className="buttonSupprimer"
  onClick={(e)=>{
    let searchParams = new URLSearchParams(window.location.search);
    let idProduit;
    for (let p of searchParams) {
    ...
    suppressionTexte(supprimetexte, idProduit);
  suppressionTexteCharge(supprimetexte, idProduit);
}}
  >Supprimer</button>
}
