...
router.post("/modificationtexte", authentification, apiCtrl.modificationTexte);
...
router.post("/modificationtextecharge", authentificationcharge, apiCtrl.modificationTexteCharge);
